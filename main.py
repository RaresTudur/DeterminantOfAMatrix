...
def determinant_high_school(matrix):
    dim = len(matrix)
    if dim < 1:
        return 0
    ...
    for i in range(dim):
        ...
        subdet = determinant_high_school(submatrix)
...
def interface():
    ...
    print("2. High School Method")
    method_selector = int(input())
    match method_selector:
        case 1:
            print("The determinant of the matrix is", determinant_high_school(matrix))
        case 2:
